...
(function () {
  ...
  window.AK_VAPID_KEY = 'BPJ6f-EuviZCH1T7iTPisGhSRKSWDdEUq9O1WBKBLev0R9HKMoUSOSfspqm1VFZGn3q8C-LgqoV7SFX7G-G9VIo';
  ...
  function onAllLoaded() {
    try {
      ...
      window.akFirebaseReady = true;
      console.info(
        '%c[Atharav Kitchen] ✅ Firebase LIVE — Cloud sync ACTIVE!',
        ...
        if (firebase.messaging && firebase.messaging.isSupported) {
          firebase.messaging
            ...
            .then(function (supported) {
              if (supported) {
                try {
                  window.akMessaging = firebase.messaging();
                } catch (e) {
                  window.akMessaging = null;
                }
              }
