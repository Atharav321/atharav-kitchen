...
function ownerWhatsApp(){if(!_lastOrder)return;var o=_lastOrder;var trackUrl='https://atharav-kitchen.pages.dev/tracking.html?order='+encodeURIComponent(o.id);var msg='✅ *ORDER CONFIRMED — ATHARAV KITCHEN*\n\nHi '+o.name+'! 🎉\n\nYour order *#'+o.id+'* is confirmed!\n\n💰 *Total: ₹'+o.bill.total+'*\n🛵 ETA: 30-45 mins\n\n📍 *LIVE TRACK YOUR ORDER:*\n'+trackUrl+'\n\nIs link se real-time map mein dekho rider kahan hai! 🗺️\n\n🍽️ Atharav Kitchen — Taste That Travels Fast!';window.open('https://wa.me/'+o.phone.replace(/[^0-9]/g,'')+'?text='+encodeURIComponent(msg),'_blank');}
